...
export function FrictionAngleProfileTab({ unitSystem }: FrictionAngleProfileTabProps) {
    ...
    <section className="space-y-5">
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-600">
          This layer profile computes &phi;&prime; directly from entered N<sub>60</sub> at each sample depth. Points
          are grouped by Borehole ID and shown as scatter markers without line interpolation.
        </p>
      </div>
    </section>
  );
